//alert($("#currentval").val())
 alglist=$('#currentval').val()

 date=$('#currentdate').val()
array=alglist.replace('[', '');
                                                
var replace=array.replace("]", '');
                                              
  array=replace.replace(/\"/g, "")
   array = array.split(',');
   value=[]
